      ...
      <header className="border-b border-b-foreground/10">
        <nav className="w-full flex justify-between items-center p-4 px-6">
          <div className="flex items-center gap-8">
            <Link href="/dashboard/admin" className="font-bold text-lg">
              POS System - Admin
            </Link>
            <div className="flex items-center gap-4">
              ...
              <Link href="/dashboard/admin/cashiers">
                <Button variant="ghost">Manage Cashiers</Button>
              </Link>
              {profile?.role === "SUPERADMIN" && (
                <Link href="/dashboard/superadmin">
                  <Button variant="ghost">Superadmin View</Button>
                </Link>
              )}
            </div>
          </div>
